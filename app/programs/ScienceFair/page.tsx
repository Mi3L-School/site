...
export default function ScienceFair() {
  ...
  const handleImgClick = () => {
    window.open(
      "https://forms.gle/SbGRwfM6WNtWwNRZ7",
      "_blank",
      "noopener,noreferrer"
    );
  };
  ...
  const paymentClick = () => {
    window.open(
      "https://www.zeffy.com/en-CA/ticketing/science-fair-summer-course--2025",
      "_blank",
      "noopener,noreferrer"
    );
  };
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 mb-8">
          <div className="text-center space-y-4 mb-8">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              Mi3L School is offering a two-week-evening Science Fair course for{" "}
              <span className="font-semibold text-gray-900">Grades 7-12</span>!
            </p>
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              <Image
                src="/images/ScienceFair.png"
                alt="Science Fair Preparation Course"
                width={600}
                height={400}
