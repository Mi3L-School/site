...
export default function VirtualSkills() {
  const handleImgClick = () => {
    window.open(
      "https://forms.gle/eisNLapUBMVmz6ew6",
      "_blank",
      "noopener,noreferrer"
    );
  };
  ...
  const paymentClick = () => {
    window.open(
      "https://www.zeffy.com/en-CA/ticketing/vexcode-virtual-skills-competition-summer-camp-aug-18--22",
      "_blank",
      "noopener,noreferrer"
    );
  };
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            VEXCode Virtual Skills Summer Camp
          </h1>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 mb-8">
          <div className="text-center space-y-4 mb-8">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              Mi3L School is offering a VEXCode Virtual Skills Summer Camp for{" "}
              <span className="font-semibold text-gray-900">Grades 5-12</span>!
            </p>
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-gray-700">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">Aug 18-22nd, 1-4pm</span>
              </div>
              <div className="flex items-center gap-2">
                <svg
                  className="w-5 h-5 text-orange-500"
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              <Image
                src="/images/NA.webp"
                alt="VEXCode Virtual Skills Summer Camp"
                width={600}
                height={400}
