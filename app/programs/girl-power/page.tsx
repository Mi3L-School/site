  ...
  return (
    <main className="min-h-screen bg-gray-50 px-6 py-20 text-gray-900">
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-10 shadow-sm">
        ...
        <h1 className="text-4xl font-bold">Girl Power</h1>
        <p className="mt-6 text-lg leading-8 text-gray-600">
          Girl Power programs encourage confidence, leadership, and creativity through inspiring STEM and life-skills activities.
        </p>
