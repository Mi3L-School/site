...
export default function RoboticsPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      {/* SECTION 5: 12 WEEK TRAINING — TEMPORARILY HIDDEN */}
      <section className="hidden py-16 bg-gray-900 text-white overflow-hidden relative border-t border-gray-800" aria-hidden="true">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-32 self-center">
                <div className="rounded-3xl overflow-hidden shadow-2xl">
                  <img 
                    src="/images/homepage/content.jpg" 
                    alt="Class Activity" 
      ...
      {/* SECTION 7: TIMELINES — TEMPORARILY HIDDEN */}
      <section className="hidden py-24 bg-gray-50" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="hidden lg:block mb-32">
              <img src="2-1.png" alt="VRC Season Timeline Desktop" className="w-full h-auto rounded-3xl" />
           </div>
           {/* Mobile Timeline */}
           <div className="lg:hidden mb-32">
              <img src="-1.png" alt="VRC Season Timeline Mobile" className="w-full h-auto rounded-3xl" />
           </div>
