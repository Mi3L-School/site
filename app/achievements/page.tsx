...
const teams = [
  ...
  },
  {
    ...
    achievements25: [
      ...
      "Ontario MS Provincial Championship Innovate Award & World Championship Qualifier",
  ...
  },
  {
    ...
    achievements24: [],
    achievements25: [
      "Judges Award @ Ontario Provincials Championship",
      "Innovate Award @ iDesign Toronto Tournament",
    ],
  },
  {
    id: "arialdrone",
    ...
    achievements23: [],
    achievements24: [
      "Online Challenges Drone Career Readiness Winner",
      "Code Award @ North Central Championship",
      "Judge Award @ Drones in Oxford MA",
    ],
    achievements25: [
      "All Around Award @ Local Qualifier",
      "Skills Champion @ Local Qualifier",
      "Communication Award @ Local Qualifier",
      "All Around Award @ North Central Championship",
      "Team Work Finalist @ North Central Championship",
      "Code Award @ North Central Championship",
    ],
  },
];
